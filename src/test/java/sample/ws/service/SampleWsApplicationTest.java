...
public class SampleWsApplicationTest {
  ...
  @Before
  public void setUp() {
    this.webServiceTemplate.setDefaultUri("http://localhost:" + this.port + "/Service/HelloPort");
  }
  ...
  public void testHelloRequest() {
    ...
    String request =
        "<q0:sayHello xmlns:q0=\"http://service.ws.sample/\"><myname>Elan</myname></q0:sayHello>";
